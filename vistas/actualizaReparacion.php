...
$reparacion = new Reparacion($reparacion_id, $_POST['cliente_id'], $_POST['marcamodelo'], $_POST['imei'],
...
$exito = actualizaReparacion($username, $password, $reparacion);
if($exito)
    header("location: listaReparaciones.php");
?>